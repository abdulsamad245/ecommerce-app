				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $final['category_id']; ?>">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="product-detail.php?product_details_id=<?php echo $final['id']?>" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								Quick View
							</a>
						</div>
...
<?php }?>
			...
			<!-- Load more -->
			<div class="flex-c-m flex-w w-full p-t-45 mt-5">
